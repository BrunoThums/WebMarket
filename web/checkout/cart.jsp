...
<html>
    ...
    <div class="container mt-5 mb-5">
        <div class="d-flex justify-content-center row">
            <div class="col-md-8" style="background-color: #ecedee">
                <div class="p-2">
                    ...
                    <div class="d-flex flex-row align-items-center mt-3 p-2 bg-white rounded"><a class="btn btn-warning btn-block btn-lg ml-2 pay-button" type="button" href="/WebMarket/checkout/checkout.jsp">Prosseguir para Pagamento</a></div>
                    <%} else {%>
        ...
        <script  src="/WebMarket/checkout/cart.css"></script>
    </body>
</head>